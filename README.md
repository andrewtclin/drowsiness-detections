...
- Demo video showcasing Drowsiness Detection application in action:
...
- Drowsiness Detection is an application that utilizes YOLOv5 and custom image data to detect whether a person appears drowsy or awake.
